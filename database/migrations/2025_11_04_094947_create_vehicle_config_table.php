...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('vehicle_config', function (Blueprint $table) {
            ...
            $table->integer('direction_dynamics')->default(100)->comment('方向中位微调');
//            $table->integer('turn_left')->default(100)->comment('方向左转微调'); //去除
//            $table->integer('turn_right')->default(100)->comment('方向右转微调');//去除
            $table->integer('accelerator_dynamics')->default(100)->comment('油门中位微调');
            $table->integer('direction_center')->default(100)->comment('方向力度微调');
            $table->integer('accelerator_center')->default(100)->comment('油门力度微调');
